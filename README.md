...
## 요구사항
- Ubuntu Desktop 24.04 (amd64) or Raspberry Pi 4B/5 (arm64, Debian 13 Trixie)
- RAM 8GiB 이상
- System Storage 8GB 이상 (OS/DB 제외)
## 설치

### KIOSK 모드 (NVR형태)
모니터가 직접 연결되는 시스템으로 디코딩 및 디스플레이용도로 GPU가 필요합니다. (라즈베리파이는 GPU문제로 추천하지 않습니다.)
```bash
